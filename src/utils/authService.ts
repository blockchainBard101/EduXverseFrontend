...
export class AuthService {
    ...
    // static async generateZkLoginSignature(userSignature: string): Promise<SerializeSignatureInput> {
    ...
    async login() {
        ...
        // const userName = AuthService.gmail_address();
        // AuthService.addUser(userName, walletAddress);
    }

    static async addUser(name: string, userAdress: string) {
        try {
