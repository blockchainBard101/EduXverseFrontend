...
import './ConnectInteract.css';
import { RiAccountCircleFill } from "react-icons/ri";
import { FaUserFriends } from "react-icons/fa";
import { spaceInfos, spotsList, topPicks } from '../../utils';

const ConnectInteract = () => {
  const [connectInteract, setConnectInteract] = useState('spaces');
      ...
      <div className="forYouFavorites-morphism-bg">
        <h1>
          <span 
            ...
            onClick={() => setConnectInteract('spaces')}
          >
            Spaces
          </span>
          <span 
            onClick={() => setConnectInteract('spots')}
          >
            Saved
          </span>
        </h1>
        <div>
          {connectInteract === 'spaces'
...
export default ConnectInteract;
